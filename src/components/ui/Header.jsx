...
export default function Header() {
  return (
    <div className="w-full h-[142px] bg-indigo-500">
      {/* Navigation panel all kategory*/}
      <div className="w-full h-[86px] bg-emerald-500 flex justify-center items-center">
        <div>
          <img src={megapartsLogo} alt="" />
        </div>
      ...
      {/* Filter navigation */}
      <div className="w-full h-[56px] bg-yellow-500">Filter panel</div>
    </div>
  );
}
