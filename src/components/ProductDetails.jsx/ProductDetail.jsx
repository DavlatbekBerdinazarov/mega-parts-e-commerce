...
import { FaCheck, FaE } from "react-icons/fa6";
      ...
      <figure className="flex flex-col lg:flex-row gap-5">
        ...
        <div>
          ...
          <div className="md:hidden border-b-[1px] border-[#BDC1C8]">
              ...
              <p className="mt-2">Info about edu item is an ideal companion for anyone engaged in learning. The drone provides precise and ...</p>
              <Link to="#" className="text-[#127FFF] font-semibold"  >Read more</Link>
            </div>
