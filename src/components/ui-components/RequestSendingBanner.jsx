...
export default function RequestSendingBanner() {
  return (
    <div className='w-full h-[446px] relative'>
        ...
        <div className='w-full h-full absolute top-0 p-10 flex justify-between  rounded-lg'>
          {/* content */}
          <div className="w-[440px] text-white">
            <h1 className="text-3xl my-3 font-semibold">An easy way to send requests to all suppliers</h1>
            <p className="text-lg ">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
          </div>
          {/* form */}
          <form className='bg-white w-2/5 max-h-[346px] rounded-md p-6 flex flex-col gap-4'>
